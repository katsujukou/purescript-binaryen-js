...
export const _add = function (Tuple, offset, ptr, value, name, m) {
  const expr = m.i32.atomic.rmw32_u.add(offset, ptr, value, name);
  return Tuple(m)(expr);
}
...
export const _sub = function (Tuple, offset, ptr, value, name, m) {
  const expr = m.i32.atomic.rmw32_u.sub(offset, ptr, value, name);
  return Tuple(m)(expr);
}
...
export const _and = function (Tuple, offset, ptr, value, name, m) {
  const expr = m.i32.atomic.rmw32_u.and(offset, ptr, value, name);
  return Tuple(m)(expr);
}
...
export const _or = function (Tuple, offset, ptr, value, name, m) {
  const expr = m.i32.atomic.rmw32_u.or(offset, ptr, value, name);
  return Tuple(m)(expr);
}
...
export const _xor = function (Tuple, offset, ptr, value, name, m) {
  const expr = m.i32.atomic.rmw32_u.xor(offset, ptr, value, name);
  return Tuple(m)(expr);
}
...
export const _xchg = function (Tuple, offset, ptr, value, name, m) {
  const expr = m.i32.atomic.rmw32_u.xchg(offset, ptr, value, name);
  return Tuple(m)(expr);
}
...
export const _cmpxchg = function (Tuple, offset, ptr, expected, replacement, name, m) {
  const expr = m.i32.atomic.rmw32_u.cmpxchg(offset, ptr, expected, replacement, name);
  return Tuple(m)(expr);
}
