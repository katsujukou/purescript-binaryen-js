...
foreign import _convert_low_i32x4_s :: BinaryenFn1 ExpressionRef ExpressionRef

convert_low_i32x4_s :: ExpressionRef -> Binaryen ExpressionRef
convert_low_i32x4_s value = runBinaryenFn1 _convert_low_i32x4_s value

-- convert_low_i32x4_u(value: ExpressionRef): ExpressionRef;
foreign import _convert_low_i32x4_u :: BinaryenFn1 ExpressionRef ExpressionRef

convert_low_i32x4_u :: ExpressionRef -> Binaryen ExpressionRef
convert_low_i32x4_u value = runBinaryenFn1 _convert_low_i32x4_u value

-- promote_low_f32x4(value: ExpressionRef): ExpressionRef;
foreign import _promote_low_f32x4 :: BinaryenFn1 ExpressionRef ExpressionRef

promote_low_f32x4 :: ExpressionRef -> Binaryen ExpressionRef
promote_low_f32x4 value = runBinaryenFn1 _promote_low_f32x4 value
