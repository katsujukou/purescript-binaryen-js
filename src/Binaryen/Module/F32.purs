...
foreign import _const_bits :: BinaryenFn1 Number ExpressionRef

const_bits :: Number -> Binaryen ExpressionRef
const_bits value = runBinaryenFn1 _const_bits value
...
foreign import _demote :: BinaryenFn1 ExpressionRef ExpressionRef

demote :: ExpressionRef -> Binaryen ExpressionRef
demote value = runBinaryenFn1 _demote value
